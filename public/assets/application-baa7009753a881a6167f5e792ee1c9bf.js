...
(function() {
  jQuery(function() {
    var Breakfast0, Breakfast0regret, Breakfast1, Breakfast1regret, Wedding0, Wedding0regret, Wedding1, Wedding1regret, Welcome0, Welcome0regret, Welcome1, Welcome1regret;
    ...
    Breakfast0 = $('#household_guests_attributes_0_breakast_true');
    ...
    Welcome0.change(function() {
      if (Welcome0.prop("checked") === true) {
        return $('#Email0').css('display', 'block');
      }
    });
    ...
    Welcome1.change(function() {
      if (Welcome1.prop("checked") === true) {
        return $('#Email1').css('display', 'block');
      }
    });
    ...
    return Breakfast1regret.change(function() {
      if (Welcome1regret.prop("checked") === true && Wedding1regret.prop("checked") === true && Breakfast1regret.prop("checked") === true) {
        return $('#Email1').css('display', 'none');
      }
    });
