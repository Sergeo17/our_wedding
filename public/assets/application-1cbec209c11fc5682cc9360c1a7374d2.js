...
(function() {
  jQuery(function() {
    var Breakfast0, Breakfast0regret, Breakfast1, Breakfast1regret, DeclineGuest1, RSVPSubmit, Shuttle0false, Shuttle0true, Shuttle1false, Shuttle1true, Wedding0, Wedding0regret, Wedding1, Wedding1regret, Welcome0, Welcome0regret, Welcome1, Welcome1regret;
    ...
    $('#searchformsubmit').on('click', function(event) {
      var lastname, zipcode;
      lastname = document.getElementById("searchformlastname").value;
      zipcode = document.getElementById("searchformzipcode").value;
      if (lastname === null || lastname === "" || zipcode === null || zipcode === "") {
        alert("The last name and ZIP code is required");
        return false;
      }
    });
    $(".householdsedit").ready(function() {
      if (Wedding0.prop("checked") === true) {
        $('#Email0').show(200);
        $('#Wedding0').show(200);
      }
      if (Wedding1.prop("checked") === true) {
        $('#Email1').show(200);
        return $('#Wedding1').show(200);
      }
    });
    ...
    Welcome0.change(function() {
      if (Welcome0.prop("checked") === true) {
        return $('#Email0').show(200);
      }
    });
    Welcome0regret.change(function() {
      if (Welcome0regret.prop("checked") === true && Wedding0regret.prop("checked") === true && Breakfast0regret.prop("checked") === true) {
        return $('#Email0').hide(200);
      }
    });
    Wedding0.change(function() {
      if (Wedding0.prop("checked") === true) {
        $('#Email0').show(200);
        return $('#Wedding0').show(200);
      }
    });
    Wedding0regret.change(function() {
      if (Welcome0regret.prop("checked") === true && Wedding0regret.prop("checked") === true && Breakfast0regret.prop("checked") === true) {
        $('#Email0').hide(200);
        return $('#Wedding0').hide(200);
      } else if (Wedding0regret.prop("checked") === true) {
        return $('#Wedding0').hide(200);
      }
    });
    Breakfast0.change(function() {
      if (Breakfast0.prop("checked") === true) {
        return $('#Email0').show(200);
      }
    });
    Breakfast0regret.change(function() {
      if (Welcome0regret.prop("checked") === true && Wedding0regret.prop("checked") === true && Breakfast0regret.prop("checked") === true) {
        return $('#Email0').hide(200);
      }
    });
    Welcome1.change(function() {
      if (Welcome1.prop("checked") === true) {
        return $('#Email1').show(200);
      }
    });
    Welcome1regret.change(function() {
      if (Welcome1regret.prop("checked") === true && Wedding1regret.prop("checked") === true && Breakfast1regret.prop("checked") === true) {
        return $('#Email1').hide(200);
      }
    });
    Wedding1.change(function() {
      if (Wedding1.prop("checked") === true) {
        $('#Email1').show(200);
        return $('#Wedding1').show(200);
      }
    });
    Wedding1regret.change(function() {
      if (Welcome1regret.prop("checked") === true && Wedding1regret.prop("checked") === true && Breakfast1regret.prop("checked") === true) {
        $('#Email1').hide(200);
        return $('#Wedding1').hide(200);
      } else if (Wedding1regret.prop("checked") === true) {
        return $('#Wedding1').hide(200);
      }
    });
    Breakfast1.change(function() {
      if (Breakfast1.prop("checked") === true) {
        return $('#Email1').show(200);
      }
    });
    Breakfast1regret.change(function() {
      if (Welcome1regret.prop("checked") === true && Wedding1regret.prop("checked") === true && Breakfast1regret.prop("checked") === true) {
        return $('#Email1').hide(200);
      }
    });
    return DeclineGuest1.change(function() {
      if (DeclineGuest1.prop("checked") === true) {
        $('#RSVPFields1').hide(200);
      }
      if (DeclineGuest1.prop("checked") === false) {
        return $('#RSVPFields1').show(200);
      }
    });
  });
